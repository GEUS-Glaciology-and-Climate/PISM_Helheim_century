#+Title: Code for: Century-scale hindcasting of glacier flux using ice-rafted debris: A step toward improved model initialisation
...
**** Take a look at the pism model file using xarray

 #+BEGIN_SRC python :results output
import xarray as xr
import numpy as np

with xr.open_dataset('pism_greenland_1km_v2-filled.nc') as src:
    variable='thk'
    ...
    print(src[variable].min())
    print(src[variable].max())
    #src.topg.plot()
 #+END_SRC
 ...
 KeyError: [<class 'netCDF4._netCDF4.Dataset'>, ('/home/shl/OneDrive/projects/dynahide_v2/pism_greenland_1km_v2-filled.nc',), 'r', (('clobber', True), ('diskless', False), ('format', 'NETCDF4'), ('persist', False))]

 During handling of the above exception, another exception occurred:

 OSError                                   Traceback (most recent call last)
 /tmp/ipykernel_10139/1535156387.py in <module>
       2 import numpy as np
       3 
 ----> 4 with xr.open_dataset('pism_greenland_1km_v2-filled.nc') as src:
       5     variable='thk'
       6     #variable='climatic_mass_balance'
 ...
 ~/miniconda3/envs/py38/lib/python3.8/site-packages/xarray/backends/netCDF4_.py in open(cls, filename, mode, format, group, clobber, diskless, persist, lock, lock_maker, autoclose)
 ...
 ~/miniconda3/envs/py38/lib/python3.8/site-packages/xarray/backends/netCDF4_.py in __init__(self, manager, group, mode, lock, autoclose)
 ...
 ~/miniconda3/envs/py38/lib/python3.8/site-packages/xarray/backends/netCDF4_.py in ds(self)
     365     @property
     366     def ds(self):
 ...
 ~/miniconda3/envs/py38/lib/python3.8/site-packages/xarray/backends/netCDF4_.py in _acquire(self, needs_lock)
     359 
     360     def _acquire(self, needs_lock=True):
 ...
 OSError: [Errno -51] NetCDF: Unknown file format: b'/home/shl/OneDrive/projects/dynahide_v2/pism_greenland_1km_v2-filled.nc'
 :end:
...
# Model list
models = [
    "relax_1st_cycle_E3_v4.21",
    "relax_2nd_cycle_E3_v4.21",
    "relax_3rd_cycle_E3_v4.21",
    "relax_4th_cycle_E3_v4.21",
    "relax_5th_cycle_E3_v4.21",
    "relax_6th_cycle_E3_v4.21",
    "relax_7th_cycle_E3_v4.21",
    "relax_8th_cycle_E3_v4.21",
    "relax_9th_cycle_E3_v4.21",
    "relax_10th_cycle_E3_v4.21",
    "relax_11th_cycle_E3_v4.21"
    ]

#    "control_1st_relax_E3_v4.21",
#    "control_2nd_relax_E3_v4.21",
#    "control_3rd_relax_E3_v4.21",
#    "control_4th_relax_E3_v4.21",
#    "control_5th_relax_E3_v4.21",
#    "control_6th_relax_E3_v4.21",
#    "control_7th_relax_E3_v4.21",
#    "control_8th_relax_E3_v4.21",
#    "control_9th_relax_E3_v4.21"
#]
