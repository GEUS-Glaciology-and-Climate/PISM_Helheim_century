...
# Create the NetCDF file and add dimensions
filename = "model_input/forcing/pism_one_station_dmi_tas_noleap_plus20pc.nc"
rootgrp = Dataset(filename, "w", format="NETCDF4")
...
#+BEGIN_SRC sh
ncap2 -O -s 'defdim("nv",2);time_bnds=make_bounds(time,$nv,"time_bnds");' \
      model_input/forcing/pism_one_station_dmi_tas_noleap_plus20pc.nc model_input/forcing/pism_one_station_dmi_tas_noleap_plus20pc-with-bounds.nc
...
# Create the NetCDF file and add dimensions
filename = "model_input/forcing/pism_one_station_dmi_tas_noleap_plus40pct.nc"
rootgrp = Dataset(filename, "w", format="NETCDF4")
...
#+BEGIN_SRC sh
ncap2 -O -s 'defdim("nv",2);time_bnds=make_bounds(time,$nv,"time_bnds");' \
      model_input/forcing/pism_one_station_dmi_tas_noleap_plus40pct.nc model_input/forcing/pism_one_station_dmi_tas_noleap_plus40pct-with-bounds.nc
...
# Create the NetCDF file and add dimensions
filename = "model_input/forcing/pism_one_station_dmi_tas_noleap_minus20pct.nc"
rootgrp = Dataset(filename, "w", format="NETCDF4")
...
#+BEGIN_SRC sh
ncap2 -O -s 'defdim("nv",2);time_bnds=make_bounds(time,$nv,"time_bnds");' \
      model_input/forcing/pism_one_station_dmi_tas_noleap_minus20pct.nc model_input/forcing/pism_one_station_dmi_tas_noleap_minus20pct-with-bounds.nc
...
# Publication defaults (double-column width ≈ 180 mm)
...
# Annualize
temp_ann = temp.resample('YE').mean() - 273.15  # °C
...
# NOTE: Above assumed unit; keep your original if you’re certain.
